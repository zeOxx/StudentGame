	...
	class Gameworld : Microsoft.Xna.Framework.Game        // TODO SINGLETON
	{
		...
		private void initializeGameworld(ContentHolder contentHolder)
		{
			...
			for (int i = 0; i < 20; i++)
			{
				...
				enemies.Add(new Enemy(contentHolder.textureEnemy01, contentHolder.texturePlayerTurret, contentHolder.texturePlayerBullet, i * 20 + 200, i * 20 + 200, Vector2.Zero, 250));
			}
		}
