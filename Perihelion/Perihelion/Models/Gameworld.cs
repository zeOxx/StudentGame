...
namespace Perihelion.Models
{
    class Gameworld : Microsoft.Xna.Framework.Game        // TODO SINGLETON
    {
        ...
        private void initializeGameworld(ContentHolder contentHolder)
        {
            ...
            background01 = new Background(contentHolder.bg_variant0, playerObject.getPosition(), playerObject.getVelocity(), levelBounds, 0, 0, 0.4f);
            background02 = new Background(contentHolder.bg_variant1, playerObject.getPosition(), playerObject.getVelocity(), levelBounds, 0, 0, 0.2f);
